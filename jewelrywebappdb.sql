/*
 ...
 Source Schema         : jewelrywebapp

 Target Server Type    : MySQL
 Target Server Version : 90001 (9.0.1)
 File Encoding         : 65001

 Date: 22/10/2025 23:16:35
*/
...
-- ----------------------------
INSERT INTO `banner_image` VALUES ('2025-10-06 01:29:23.000000', 1, NULL, 'infocus', 'infocus', '/banners/banner/info-9327baf1-b41c-45de-8650-b4c55d5290e5.png');
INSERT INTO `banner_image` VALUES ('2025-10-06 01:38:18.000000', 2, NULL, 'product', 'product', '/banners/banner/banner-69f1da57-8649-4cb6-ae73-fb2f408c3c52.jpg');
INSERT INTO `banner_image` VALUES ('2025-10-06 01:38:22.000000', 3, NULL, 'home1', 'home', '/banners/banner/imga-33a0b176-a98e-420f-ac85-2fa260e27574.png');
INSERT INTO `banner_image` VALUES ('2025-10-06 01:38:34.000000', 4, NULL, 'home2', 'home', '/banners/banner/imgb-dece4ea0-09ef-4af4-a0a6-6f35d0e7b9a8.png');
INSERT INTO `banner_image` VALUES ('2025-10-06 01:38:53.000000', 5, NULL, 'home3', 'home', '/banners/banner/imgc-f6c43507-2224-4fa9-a035-c76b4fdc3f1e.png');
INSERT INTO `banner_image` VALUES ('2025-10-06 01:39:13.000000', 6, NULL, 'home4', 'home', '/banners/banner/imgd-0137969e-aacb-4e30-8ec0-4e97c9c5d8b0.png');
...
CREATE TABLE `customer`  (
  ...
  `failed_attempts` bigint NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
-- Records of manager
-- ----------------------------
INSERT INTO `manager` VALUES (NULL, NULL, 1, '2025-05-02 20:42:46.716415', NULL, NULL, '23110119@student.hcmute.edu.vn', 'Manager', '$2a$10$AfXZM.A8BdhIv/zIUizhv.lMWdveOGwk7uzzKs9Q9XNXizzc0ge7C', NULL, 'manager', NULL, 'MANAGER', 'ACTIVE', 0);
...
-- ----------------------------
INSERT INTO `privacy_and_term` VALUES ('2025-10-06 01:28:55.000000', 1, NULL, '<p><strong>1. CHÍNH SÁCH ĐỔI & TRẢ HÀNG / RETURNS AND EXCHANGE POLICY</strong></p>\r\n<p><strong>Tất cả các hàng hóa bán ra sẽ không được áp dụng trả hàng hoặc đổi hàng.</strong><br>No returns or exchanges are applied for all purchased products.</p>\r\n\r\n<p><strong>2. QUY ĐỊNH ĐỔI HÀNG / EXCHANGE POLICY</strong></p>\r\n<ul>\r\n    <li>Chính sách đổi hàng áp dụng cho các sản phẩm bị lỗi kỹ thuật.<br>Exchange policy is applied for faulty/defective items</li>\r\n    <li>Áp dụng một đổi một trong vòng 15 ngày kể từ ngày nhận hàng và chỉ đổi duy nhất 1 lần khi có lỗi kỹ thuật ở sản phẩm.<br>One-for-One exchange will be applied within 15 days of receipt of the purchase and be applied ONCE only for faulty items.</li>\r\n    <li>Yêu cầu đổi hàng của quý khách sẽ được nhân viên tiếp nhận và Shiny Jewelry sẽ là bên đưa ra quyết định cuối cùng về kết quả và thông tin đến quý khách không quá 12 ngày làm việc (không tính thứ 7, Chủ Nhật và các ngày Lễ Tết).<br>Your request will be processed by our staff, and Shiny Jewelry will make final decision and inform you within 12 business days (not including Saturdays, Sundays and other public holidays).</li>\r\n    <li>Không áp dụng đổi size, đổi mẫu cho các sản phẩm áp dụng chương trình khuyến mãi.<br>Exchanges of Sizes or Models for items purchased on discount or during the sales period are NOT applicable.</li>\r\n    <li>Sản phẩm đổi phải có giá trị bằng hoặc cao hơn giá trị sản phẩm đã mua.<br>Exchanged items must be equal or higher value than originally purchased ones.</li>\r\n    <li>Không hoàn tiền chênh lệch đối với các trường hợp đổi sản phẩm có giá trị thấp hơn.<br>There is NO refund for the difference in cash/card in case of the exchanged items being less value than the original purchase.</li>\r\n    <li>Sản phẩm đổi phải là những sản phẩm trong tình trạng nguyên vẹn, chưa qua sử dụng, còn đầy đủ tem mác, phụ kiện đi kèm (hộp, túi,…) và hóa đơn mua hàng tại cửa hàng đã bán sản phẩm.<br>All items to be returned must be unused and in their original condition with all original tags, and accompanying accessories (boxes, bags,…) and the receipt of the store from which the item was originally purchased.</li>\r\n</ul>\r\n\r\n<p><strong>3. SỰ CHÊNH LỆCH VỀ GIÁ CẢ / PRICE DIFFERENTIAL</strong></p>\r\n<ul>\r\n    <li>Giá bán lẻ của sản phẩm sẽ được quy định bởi Shiny Jewelry dựa trên xu hướng, hàng hóa và nhu cầu của khách hàng. Vì vậy khi có sự thay đổi về giá bán lẻ, chúng tôi sẽ không thể hoàn khoản chênh lệch.<br>Our retail price is obliged to Shiny Jewelry based on trends, stock and customers’ needs. Therefore, we cannot refund the difference in price if any changes arise.</li>\r\n</ul>\r\n');

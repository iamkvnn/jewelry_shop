    ...
    <div className={showConfirmModal ? styles.modalOverlay : styles.hideModal}>
      <div className={styles.confirmModal}>
        ...
        <div className={styles.modalButtons}>
          <Button variant="contained" color="error" onClick={handleConfirmClearCart}>
            Xóa tất cả
          </Button>
          <Button variant="outlined" onClick={handleCancelClearCart}>
            Hủy
          </Button>
        </div>
      </div>
    ...
    <div>
      ...
      <div className={styles.cartContainer}>
        ...
        <div className={styles.cartHeader}>
          ...
          {cartItems.length > 0 && (
            <Button variant="contained" color="error" className={styles.clearCartBtn} onClick={clearCart}>
              Xóa tất cả
            </Button>
          )}
        </div>
            ...
            >
              <Grid2 container direction="row" spacing={2} sx={{ alignItems: "center" }}>
                ...
                <div className={styles.itemDetails}>
                  ...
                  {item.product?.discountPrice && (
                    <span className={styles.oldPrice}>{item.product.price.toLocaleString()}đ</span>
                  )}
              ...
              <Grid2 container direction="row" spacing={0} sx={{ alignItems: "center" }}>
                ...
                <div className={styles.icons}>
                  <Delete className={styles.icon} onClick={() => removeItem(item.id, item.productSize?.id)} />
                </div>
              </Grid2>
